...
samp1 <- replicate(m,pi1(n))
samp2 <- replicate(m,pi2(n))

cat(sprintf("La moyenne par la methode 1 est %s et la variance est %s",mean(samp1),var(samp1)))
cat(sprintf("La moyenne par la methode 2 est %s et la variance est %s",mean(samp2),var(samp2)))
```
