...
```{r}
#For an interaction between two quantitative variables, we will categorize one of them and do the same thing as before.
...
data.frame(namemod,p_value1) #table containing the p-values of the ANOVA
...
R = c(summary(mod1)$adj.r.squared,summary(mod1bis)$adj.r.squared,summary(mod_1)$adj.r.squared,summary(mod_1bis)$adj.r.squared) #vector of criteria
...
```{r}
#model to test the interaction parent education X school type
